...
/**
 * Run4Rights Privacy Policy Component (Standalone)
 * - TailwindCSS styling, mobile-first
 * - No external UI deps
 * - Accessible markup with headings, landmark regions, and skip links
 * - Props let you customize lastUpdated and contact email without editing text
 */
  ...
  contactEmail?: string;
    ...
    return (
        <div className="w-full flex flex-row overflow-hidden">
            <div className="w-1/2 sm:block hidden sticky top-0" id='left-side'>
            ...
            <div className="flex justify-center grow overflow-scroll m-4" id="right-side">
                    <div>
                    ...
                    <div className="grid gap-8">
                        ...
                        <Typography color="primary" variant="h4" id="info">1. Information We Collect</Typography>
                        ...
                        <Typography color="primary" variant="h4" id="use">2. How We Use Information</Typography>
                        <List>
                        ...
                        <Typography color="primary" variant="h4" id="security">3. Data Storage and Security</Typography>
                        <List>
                        ...
                        <Typography color="primary" variant="h4" id="third">4. Third-Party Services</Typography>
                        ...
                        <Typography color="primary" variant="h4" id="children" >5. Children’s Privacy</Typography>
                        ...
                        <Typography color="primary" variant="h4" id="rights" >6. Your Rights</Typography>
                        <Typography color="primary" variant="body2">
                        ...
                        <Typography color="primary" variant="h4" id="changes">7. Changes to This Policy</Typography>
                        <Typography color="primary" variant="body2">
                        ...
                        <Typography color="primary" variant="h4" id="contact" >8. Contact Us</Typography>
                        <Typography color="primary" variant="body2">
